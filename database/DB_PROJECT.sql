    ...
    -- Insert reviews for product with ID 1
    -- Generate sample orders
    INSERT INTO Orders (orderDate, shippingStatus, paymentStatus, shippingAddress, userID)
    VALUES 
        ('2024-05-01', 'P', 'U', '123 Main St, Anytown, USA', 1), -- User 1 order
        ('2024-05-02', 'P', 'U', '456 Elm St, Anytown, USA', 2), -- User 2 order
        ('2024-05-03', 'P', 'U', '789 Oak St, Anytown, USA', 3), -- User 3 order
        ('2024-05-04', 'P', 'U', '101 Pine St, Anytown, USA', 4), -- User 4 order
        ('2024-05-05', 'P', 'U', '222 Cedar St, Anytown, USA', 5); -- User 5 order


    -- Generate order details
    INSERT INTO OrderDetails (orderID, userID, productID, quantityOfProduct)
    VALUES 
        (1, 1, 1, 1), -- User 1 orders product 1
        (2, 2, 2, 2), -- User 2 orders two units of product 2
        (3, 3, 3, 1), -- User 3 orders product 3
        (4, 4, 4, 1), -- User 4 orders product 4
        (5, 5, 5, 2), -- User 5 orders two units of product 5
        (5, 5, 2, 1); -- User 5 also orders one unit of product 2



    INSERT INTO Reviews (userID, productID, orderID, Text, rating)
    VALUES (1, 1, 1, 'Great product! Really satisfied with my purchase.', 5),
        (2, 1, 2, 'Excellent performance and build quality.', 5),
        (3, 1, 3, 'Good value for the price.', 4);

    -- Insert reviews for product with ID 2
    INSERT INTO Reviews (userID, productID, orderID, Text, rating)
    VALUES (4, 2, 4, 'Very comfortable chair, perfect for long gaming sessions.', 5),
        (5, 2, 5, 'Sturdy construction and easy to assemble.', 4);
